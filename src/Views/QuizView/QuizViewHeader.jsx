...
//   const hours = Math.floor(selectedCourse.duration);
//   const minutes = Math.round((selectedCourse.duration - hours) * 60);
...
//           const remainingTimeStr = `${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`;
