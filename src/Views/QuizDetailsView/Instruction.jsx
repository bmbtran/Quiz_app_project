  ...
  return (
    ...
    <div className= "flex flex-col space-y-4 mt-3 text-black px-10 font-nunito ">
        ...
        <div className=' space-y-4'>
          <QuizInfo detailsImage={questions} detailsTitle={`${selectedCourse.quiz.length} questions`} details="10 points for a correct answer"/>
          <QuizInfo detailsImage={time} detailsTitle={`${selectedCourse.duration} ${selectedCourse.duration > 1 ? "hours" : "hour"}`} details="Total duration of the quiz"/>
        ...
        <Link to={{ pathname: `/course/${selectedCourse.id}/quiz`}}  className="text-white bg-gradient-to-r from-blue-700 via-blue-500 to-blue-400 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Start Quiz </Link>
